...
namespace PJT09_5
{
    public partial class Form1 : Form
    {
        ...
        {
            if (e.Node.Text == "강아지1")
                pb_pet.Image = Bitmap.FromFile("D:/CookC#/images/dog1.png");
            else if (e.Node.Text == "강아지2")
                pb_pet.Image = Bitmap.FromFile("D:/CookC#/images/dog2.png");
            else if (e.Node.Text == "고양이1")
                pb_pet.Image = Bitmap.FromFile("D:/CookC#/images/cat1.png");
            else if (e.Node.Text == "고양이2")
                pb_pet.Image = Bitmap.FromFile("D:/CookC#/images/cat2.png");
            else if (e.Node.Text == "새1")
                pb_pet.Image = Bitmap.FromFile("D:/CookC#/images/bird1.png");
            else if (e.Node.Text == "새2")
                pb_pet.Image = Bitmap.FromFile("D:/CookC#/images/bird2.png");
        }
